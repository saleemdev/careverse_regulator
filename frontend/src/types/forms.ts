...
export const licenseAppealSchema = z.object({
  ...
  detailedExplanation: z.string().min(50, 'Please provide a detailed explanation (at least 50 characters)'),

  factualErrors: z.string().optional(),
  newEvidence: z.string().optional(),
  proceduralIssues: z.string().optional(),
  requestedRelief: z.string().min(20, 'Please specify the relief you are requesting (at least 20 characters)'),
