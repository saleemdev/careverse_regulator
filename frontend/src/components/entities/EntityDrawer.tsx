  ...
  const renderContent = () => {
    switch (state.type) {
      case 'professional':
        return (
          <ProfessionalDrawer
            professional={state.data as Professional}
      ...
      case 'facility':
        return (
          <FacilityDrawer
            facility={state.data as Facility}
            loading={state.loading}
          />
        )
      case 'inspection':
        return (
          <InspectionDrawer
            inspection={state.data as Inspection}
            loading={state.loading}
          />
        )
      case 'license':
        ...
        <SheetHeader className="px-6 pt-6 pb-4">
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <SheetDescription>
                View detailed information about this {state.type}
              </SheetDescription>
            </div>
          </div>
        </SheetHeader>
